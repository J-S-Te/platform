...
type managementApplicationService interface {
	...
	ListOrgUnits(context.Context, string, string, string) (application.PageResult[domain.OrgUnit], error)
	CreateOrgUnit(context.Context, application.OrgUnitCreateInput) (domain.OrgUnit, error)
	ListPositions(context.Context, string, string, string) (application.PageResult[domain.Position], error)
...
func (handler *ManagementHandler) CreateUser(writer http.ResponseWriter, request *http.Request) {
	...
	result, err := handler.service.CreateUser(request.Context(), application.UserCreateInput{TenantID: principal.Tenant.ID, OperatorID: principal.User.ID, DisplayName: payload.DisplayName, EmployeeNo: payload.EmployeeNo, Email: payload.Email, Mobile: payload.Mobile, Status: status})
	if err != nil {
		handler.writeError(writer, request, err)
		return
	}
...
func (handler *ManagementHandler) ListOrgUnits(writer http.ResponseWriter, request *http.Request) {
	...
	result, err := handler.service.ListOrgUnits(request.Context(), principal.Tenant.ID, strings.TrimSpace(request.URL.Query().Get("keyword")), strings.TrimSpace(request.URL.Query().Get("filter[status]")))
	if err != nil {
		handler.writeError(writer, request, err)
		return
	}
...
func (handler *ManagementHandler) CreateOrgUnit(writer http.ResponseWriter, request *http.Request) {
	...
	result, err := handler.service.CreateOrgUnit(request.Context(), application.OrgUnitCreateInput{TenantID: principal.Tenant.ID, OperatorID: principal.User.ID, ParentID: payload.ParentID, Code: payload.Code, Name: payload.Name, SortOrder: payload.SortOrder})
	if err != nil {
		handler.writeError(writer, request, err)
		return
	}
...
func (handler *ManagementHandler) ListPositions(writer http.ResponseWriter, request *http.Request) {
	...
	result, err := handler.service.ListPositions(request.Context(), principal.Tenant.ID, strings.TrimSpace(request.URL.Query().Get("keyword")), strings.TrimSpace(request.URL.Query().Get("filter[status]")))
	if err != nil {
		handler.writeError(writer, request, err)
		return
	}
...
func (handler *ManagementHandler) CreatePosition(writer http.ResponseWriter, request *http.Request) {
	...
	result, err := handler.service.CreatePosition(request.Context(), application.PositionCreateInput{TenantID: principal.Tenant.ID, OperatorID: principal.User.ID, OrgUnitID: payload.OrgUnitID, Code: payload.Code, Name: payload.Name})
	if err != nil {
		handler.writeError(writer, request, err)
		return
	}
...
func toAccountResponse(value domain.Account) accountResponse {
	return accountResponse{AccountID: value.ID, UserID: value.UserID, AccountName: value.AccountName, Status: value.Status, LastLoginAt: value.LastLoginAt, Version: value.Version, CreatedAt: value.CreatedAt, UpdatedAt: value.UpdatedAt}
}
