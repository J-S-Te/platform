...
func (r *personnelRepoStub) UpdateStatus(context.Context, application.PersonnelChangeRequest, string, string, string, time.Time) (application.PersonnelChangeRequest, error) {
	return r.request, nil
}
